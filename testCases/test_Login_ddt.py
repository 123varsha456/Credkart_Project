...
class Test_Credkart_Login_DTT:
    XlPath="D:\\Cred_Kart_Project_Copy\\testCases\\TestData\\LoginTest.xlsx"
    ...
    def test_Credkart_Login_ddt_006(self,setup):
        ...
        Login_status_List=[]     ##Empty list variable
        ...
        for r in range(2,self.row+1):
            ...
            if self.lp.Login_Status()==False:
                ...
                if self.lp.exp_result=="Pass":
                  ...
                  self.lp.CLick_Menu_Button()
                  self.lp.CLick_Logout_Button()
                  XLutils.WriteData(self,"Sheet1",r,5,"Pass")
